...
function QuizCard({ quiz }) {
  return (
    <div 
      className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 quiz-card-hover transform transition-all duration-300 hover:-translate-y-2 flex-shrink-0"
      style={{ width: '400px' }} // Sử dụng inline style để đảm bảo width cố định
    >
